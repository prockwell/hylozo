package utils
{
	...
	{
		public static const UP:Vec2Const = new Vec2Const(0,1);
		public static const DOWN:Vec2Const = new Vec2Const(0,-1);
		public static const RIGHT:Vec2Const = new Vec2Const(1,0);
		public static const LEFT:Vec2Const = new Vec2Const(-1,0);
		...
		public function isNormalized():Boolean { return Math.abs((_x * _x + _y * _y)-1) < EPSILON_SQR; }
		public function isZero():Boolean { return _x == 0 && _y == 0; }
		public function isNear(vec2:Vec2Const):Boolean { return distanceSqr(vec2) < EPSILON_SQR; }
		public function isNearXY(x:Number, y:Number):Boolean { return distanceXYSqr(x, y) < EPSILON_SQR; }
